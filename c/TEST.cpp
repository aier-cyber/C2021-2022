...
*/
    ...
    /*
    if (x == this->field.size()-1){
        if (y == (this->field.at(0)).size()-1){
            if ((this->field.at(x-1)).at(y)){
                res++;
            }
            if ((this->field.at(x-1)).at(y-1)){
                res++;
            }
            if ((this->field.at(x)).at(y-1)){
                res++;
            }
            if ((this->field.at(0)).at(0)){
                res++;
            }
            if ((this->field.at(0)).at(y)){
                res++;
            }
            if ((this->field.at(0)).at(y-1)){
                res++;
            }
            if ((this->field.at(x)).at(0)){
                res++;
            }
            if ((this->field.at(x-1).at(0))){
                res++;
            }
        }
        else{
